...
class Maxxdev_Helper_Posttype {
	 ...
	 */
	public static function registerPostType($post_type_name, $name, $singular_name, $text_new, $text_edit, $text_watch, $text_search, $text_search_not_found, $text_no_deleted_elements, $icon_path, $rewrite = true, $show_in_nav = true, $position = false) {
		// Labels
		$labels = array(
	 ...
	 */
	public static function registerPostTypeShort($post_type_name, $name, $singular_name, $icon_path = null, $rewrite = true, $show_in_nav = true, $position = false) {
